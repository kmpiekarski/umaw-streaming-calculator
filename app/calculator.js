...
document.getElementById('plays').addEventListener('input', function() {
  ...
  document.getElementById('spotify-total-result').innerHTML = spotifyTotal.toLocaleString('en-US', { style: 'currency', currency: 'USD', minimumFractionDigits: pdecimals, maximumFractionDigits: pdecimals });  
  document.getElementById('umaw-total-result').innerHTML = umawTotal.toLocaleString('en-US', { style: 'currency', currency: 'USD', minimumFractionDigits: pdecimals, maximumFractionDigits: pdecimals });
});