...
export default function Form() {
  ...
  return (
    <main className="text-white text-center font-serif p-10 drop-shadow">
      <div className="text-3xl pt-2 pb-2 outline-blue-500">#MakeStreamingPay Royalty Calculator</div>
      <div className="grid grid-cols-1 content-center">

        <label className="text-2xl pt-4 pb-4 italic">Your Number of Streams:</label>
          <input
      ...
      <div className="grid grid-cols-1 content-center mt-10">
        ...
        <div className="text-sm mt-10 italic font-sans border-orange-200 border-2 p-5 rounded">Disclosure: due to special arrangements between Streaming services, DSPs and Labels, this is an estimate of current payout per stream.</div>
      </div>
    </main>
  );
}
